...
*   **qr-code-styling:** Herramienta profesional para la generación y diseño de códigos QR.
...
4.  **Compilar para producción (Crear el ejecutable .exe para Windows):**
    ```bash
    npm run build
    ```
    *Los archivos ejecutables listos para distribuir se generarán automáticamente en la carpeta `dist/`.*
